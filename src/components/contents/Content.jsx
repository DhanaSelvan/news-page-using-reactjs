...
const Content = () => {
    return (
        ...
        <main className='flex flex-wrap px-5 lg:px-16 my-6'>
            <section className='w-full rounded-md justify-center mb-6'>
                <img src = { cmImg } alt = "cm of Tamil Nadu Image" />
            </section>
            <section>
